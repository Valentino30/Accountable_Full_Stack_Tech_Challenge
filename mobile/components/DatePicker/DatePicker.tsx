...
export default function DatePicker({ value = null, onChange }: DatePickerProps) {
  ...
  return (
    <View style={styles.container}>
      <View style={{ flexDirection: "row", alignItems: "center" }}>
        <TouchableOpacity style={[styles.input, { flex: 1 }]} onPress={openPicker} activeOpacity={0.8}>
          <Text style={styles.inputText}>{value ? value.toDateString() : "Choose a date"}</Text>
        </TouchableOpacity>

        {value && (
          <TouchableOpacity onPress={onClear} style={{ marginLeft: 8, padding: 8 }}>
          ...
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.modalButtons}>
                ...
                <TouchableOpacity onPress={onConfirm} style={[styles.modalButton, styles.modalPrimaryButton]}>
